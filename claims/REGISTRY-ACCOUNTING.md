...
| 061 | GO-11 operational face: the encoder-side tilt (records written into the context's X-measurable directions; Gray-floor attainment operational; analytic zero-coupling flip probe) | cost | sealed 2026-08-05 (hash 90987042...); TWO pilots logged in-prereg (seed 20260828: run 1 exposed three gate defects, physics clean -- flip arm reclassified as audit-exempt blindness probe with thr(S)=thr(S') exactly; run 2 ALL PASS, tilt advantage 0.497 b/sym); 5.1 power/pilot fields carried; **governed run pending** (seed 20260830, T=400) | (pending) | GO11-encoder-tilt.json (pending) |
