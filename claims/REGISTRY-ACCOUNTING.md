...
| 060 | GO-11 conditional-region theorems: marginalization dichotomy, exact rank-one CR function (quadratic root), m=1 two-water-level frontier, m=2 matrix program + GO-10 corollary (C3 harness; every theorem R-IND-5-verified pre-assertion) | cost | sealed 2026-08-05 (hash b163cb2f...); ONE pilot logged in-prereg (seed 20260825, 618.9 s, ALL PASS, zero bars recalibrated -- campaign first); 5.1 power/pilot fields carried; **governed run pending** (seed 20260826) | (pending) | GO11-region.json (pending) |
