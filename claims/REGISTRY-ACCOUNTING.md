...
| 062 | GO-11 encoder-tilt face, second source family: binary pair source, pair-BA optimal record vs marginalized, XOR probe with exact independence | cost | sealed 2026-08-05 (hash 4f50578c...); ONE pilot logged in-prereg (seed 20260901, 39 s, ALL PASS, zero bar recalibrations; pair-BA target lands EXACTLY on binary Gray h2(p)-h2(D) = 0.0894; tilt advantage 0.5212 vs asymptotic 0.5203); 5.1 power/pilot fields carried; **governed run pending** (seed 20260902, T=400); pass -> GO-11 [replicated] on two source families | (pending) | GO11-encoder-tilt-binary.json (pending) |
