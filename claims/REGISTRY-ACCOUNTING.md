...
| 056 | KV-cache serving flip on Qwen2.5-7B: at identical bits AND identical reconstruction, error steered into the attention read subspace destroys the task, complement preserves it (operational GO-2, Tier B) | core | sealed 2d5794a as 055, **renumbered 056 pre-run** by dated amendment (collision with the earlier e1e9dfe seal; new hash 9f40590a…, prior hash preserved in the amendment); 1.5B mechanism + pilot logged in-prereg; **governed run pending** (Qwen2.5-7B, seed 20260815) | (pending) | GO-KV-pilot-1p5B.json · GO-KV-mechanism-1p5B.json (pilots); governed JSON pending |
