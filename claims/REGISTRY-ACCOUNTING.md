...
| 055 | GO-10 complementarity tax: rate/work product floors, exactness regime, discount identity, tax gap (C3 harness; rate side = regression of attributed Gray/Xiao–Luo results per the novelty sweeps) | cost | sealed 2026-08-03 (hash f08ef849…); one pre-seal pilot logged in-prereg (seed 20260809, one instrument bar corrected); governed run pending | Complementarity-tax note · LEDGER VI-10 | GO-complementarity-tax.json (pending) |
