...
| 059 | GO-10 operational face, second source family: binary complementarity tax (derived floor 1-h2(d^*q); coordinated-split joint reset) | cost | sealed 2026-08-04 (hash 6a96aba3...); pilot logged in-prereg (seed 20260821: gaps 0.208/0.039 = 0.77x/0.39x of the derived floor vs nulls -0.003/-0.004; one instrument crash fixed mid-pilot + latent-058 note; B2/B4 bars calibrated pre-seal); **governed run pending** (seed 20260822, T=400); pass -> GO-10 [replicated] on two source families | (pending) | GO10-operational-tax-binary.json (pending) |
