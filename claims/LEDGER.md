...
| GO-2 (pos. half: consumer-projected covariance *controls*) | Downstream preservation is controlled by the error covariance projected on the consumer's read subspace, tr(P_C·Σ_δ). | `[replicated]` (**open**, mechanism corroborated) | 6–8 | [GO-P-2026-004](../prereg/GO-P-2026-004-kv-keys-consumer-flip.md) | `experiments/go2_kv_keys_v4.py` | [GO2-kv-keys-v4.json](../results/GO2-kv-keys-v4.json) | B | **5/7 (proxy ❌)** | 0 / ≥2 | [v4 notes](../experiments/GO2-kv-keys-v4-NOTES.md): clean-regime **flip confirmed** (iso: a 2.5× better, 12/12; sub: b better) at fixed recon; recon can't track (Spearman 0.40/0.80). Mechanism confirmed **directly**: error-in-read-subspace fraction **a 0.406 vs b 0.122**. Missed 2 proxy bars (Var-ratio Spearman 0.80 iso; sub sign-agree 9/12). Re-test → GO-P-2026-005 (gate on tr(P_C·Σ_δ) directly). NEG-8, NEG-6, NEG-5 |
