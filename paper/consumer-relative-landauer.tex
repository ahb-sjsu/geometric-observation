...
water-filling rule for heterogeneous memory banks. Finally, for a stale Markov
...
Five consequences follow. First, the lower boundary has a direct
...
temperatures, the water level is proportional to temperature. Fifth, for a
...
\section{Gaussian read geometry and thermal water-filling}\label{sec:gaussian}
...
\begin{corollary}[Isothermal consumer-relative Landauer law]\label{cor:gauss}
...
\cite{faist2015}. These results supply the physical accounting used here; this
paper does not alter Landauer's principle.
