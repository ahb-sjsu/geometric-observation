...
the archived evidence release for this paper --- sealed preregistrations,
verification harnesses, committed result files, and a one-click replication
notebook --- is \url{https://doi.org/10.5281/zenodo.21776291}, which resolves
...
rate tested. The check replicates across five independent codebook draws
and, at bin rates near $0.41$ of the measured description rate, on a scalar
Gaussian source in the setting of
Proposition~\ref{prop:scalar-corner}.
