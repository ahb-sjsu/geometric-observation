...
\url{https://github.com/ahb-sjsu/geometric-observation/tree/tit-cr-context-1.8/paper/tit-cr-context}
(tag \texttt{tit-cr-context-1.8}) and are archived at
...
4.8, Claude Opus 5, Claude Opus 5.5, Claude Fable 5, and Claude Fable
5.1), run through
...
copy-editing throughout and for six pre-submission review passes whose
