...
misalignment dichotomy (Corollary~\ref{cor:misalign}), and the
...
$\mathbf D\preceq\Sigma_X$ forces $(1-D)(1-D_V)\ge\rho^2$, which leaves
...
relevant pair (Lemma~\ref{thm:pair}). The operational
...
are the classical corners, the classical function at $\rho=0$ and
