...
\title{Rate--Conditional-Content Tradeoffs\\ with Encoder-Observed Context}
...
\markboth{IEEE Transactions on Information Theory}{Bond: Rate--Conditional-Content Tradeoffs with Encoder-Observed Context}
...
$g^\star$ & larger root of the quadratic \eqref{eq:Pg};
...
$\Lambda$, $c$ & whitened conditional covariance and regression vector
(Sections~\ref{sec:region}, \ref{sec:vector})\\
\hline
\end{tabular}
\end{table}
