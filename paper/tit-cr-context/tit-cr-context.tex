...
thermodynamic reading of $L(D)$ as minimal ideal conditional-erasure work
is one consequence of that characterization.
...
the thermodynamic sentence is one consequence of that theorem. The proof
...
thermodynamic reading that follows. Under an ideal conditional reset, the
average work satisfies
\begin{equation}
 W_n\ \ge\ n\kb T\ln2\,L_n.
 \label{eq:landauer-bound}
\end{equation}
The reset model behind \eqref{eq:landauer-bound} is the ideal
conditional-erasure model of \cite{delrio2011,faist2015}, specialized to
classical side information: the third party may apply ideal joint
...
standard state. In the classical asymptotic regime, conditional erasure
protocols make the
...
\begin{tabular}{lcc}
\hline
 & $L$ at $D=0.1$ & $L$ at $D=0.3$\\
\hline
Instance $(\rho^2,\tau^2)=(\tfrac12,0)$ & $1.1610$ & $0.3685$\\
Instance $(\rho^2,\tau^2)=(\tfrac34,\tfrac12)$ & $1.2105$ & $0.5228$\\
Steinberg's scalar formula on the reduced pair & $1.2297$ & $0.5577$\\
\hline
\end{tabular}
\end{table}
...
The thermodynamic reading is fixed by the operational theorems of
Section~\ref{sec:operational} and, for the Gaussian source,
Appendix~\ref{app:gaussian}: $L(D)$ is the minimal ideal erasure work per
