...
Two results are primary. The conditional content has a closed form for
...
And the region of jointly achievable rate and conditional content is
...
partially informative, and the tradeoff persists when the copy is clean. A structural consequence is that the
...
rate--distortion function, Gray's conditional function, and Steinberg's
scalar Gaussian formula. The rate--content frontier of the doubly
symmetric binary case is traced through a tilt equation, and coding
theorems, including a
direct proof for the Gaussian source, give the conditional content its
operational meaning as the least normalized conditional entropy of the
stored index.
\end{abstract}
...
thermodynamic reading of this quantity, as the infimum of the average erasure
