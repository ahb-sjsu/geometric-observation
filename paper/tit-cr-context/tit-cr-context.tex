...
binary source, and its rate is the binary conditional-content function;
the binary contribution here is the joint frontier
...
that must not corrupt reproducibility; here $S$ is held by a third party
...
$(\rho^2,\tau^2,D)=(0.75,0.5,0.3)$, the second instance of
