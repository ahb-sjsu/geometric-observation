...
side, the channel \eqref{eq:channel} has, as $\rho^2\to1$,
...
\to\tfrac12\log_2(1/D)=R_{\min}$. As $\tau^2\to\infty$,
...
the Pareto frontier of the binary rate--content region at distortion
$D$ is the lower-left envelope of the curve
\[
