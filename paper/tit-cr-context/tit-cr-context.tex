...
is dropped. The present problem is the limit $D_V\to\infty$ of theirs,
...
unpenalized. On the admissible range the inequality is strict, the
constraint on $V$ binding (ten thousand random instances,
Appendix~\ref{app:numver}), and the formal continuation of the formula
to $D_V=\operatorname{Var}V$ equals Gray's clean-context function
...
and $\epsilon$, such that for every $n$ there is a deterministic code
