...
The author used a large language model assistant for source preparation
and editing, for the prior-art search summarized in Section~\ref{sec:intro},
for writing the independent numerical check scripts of
Appendix~\ref{app:numver}, and for pre-submission review of the
