...
\large GO-14 statement v0.8 --- Theorems R, C and T (the convex
...
chain carries no remaining estimate}
\author{Geometric Observation program}
\date{v0.8 --- August 2026 (v0.7 superseded for
...
of \S\ref{sec:anchors} through Corollary~\ref{cor:lower}. Equally, the
...
non-rationality of the stationary optimum makes non-trivial. It is
untouched by Theorem~\ref{lem:R1}, and until it is settled nothing may
be said about $L^\infty$ beyond the bracket of
Remark~\ref{rem:onedirection}. The \textbf{novelty sweep on the (R1)
combination} --- blocked
