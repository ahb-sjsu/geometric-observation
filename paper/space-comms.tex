...
heterogeneity confirmed the boundary directly: identical classes give
$G=1.000$, opening smoothly to $1.267$ as classes differentiate, with
$G_{\mathrm{meas}}/(\AM/\GM)=1.000$ throughout.
...
within $0.004$ across delays from $2$ to $2000$ steps, and the fitted
$\kappa$ read $0.696$--$0.704$ against the derived $0.70$.
