...
warns that single-stage retrieval is at or past its vacuity point---budget for a
re-ranking stage or a larger index before deployment---while $\rho$ comfortably above
$1$ indicates headroom. Because $\rho$ preserves the recall \emph{ordering} across
corpora, it also ranks candidate corpora or index configurations \emph{without}
