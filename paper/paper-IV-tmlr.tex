...
before any code is built (the gradient-coupling null). A stronger magnitude law fails an
honest test --- read-subspace energy and the quantizer regime confound it --- so we report
$\kalign$ as a coupling-null predictor, not a continuous dial. Which code best exposes the flip is set not
