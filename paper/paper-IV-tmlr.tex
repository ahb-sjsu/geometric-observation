...
\paragraph{Limitations.} The three (A2) diagnostics (music, moral, keys) are one-metric,
not sealed flips; the array read operators are oracle-informed proxies (Methods); radar is
data-limited; each domain uses a single model and dataset; the clustered/hierarchical
re-analysis (App.~\ref{app:domains}) and an independent replication remain open. And the $\kalign$ coordinate delivers less
