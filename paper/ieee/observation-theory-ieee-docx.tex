...
scalar quadratic-Gaussian case [26], [27], the parallel case
...
theorem [34] (which extends Rimoldi's finite-alphabet per-stage-measure
...
boundary rates, and the abstract-source achievability of [34] (finite
alphabets: [33]) lifts the single-letter point to $\mathcal R$. Upward closure
supplies the rest.
\end{proof}
...
[34] extend verbatim to $k$ stages (cf.\ the discrete multiresolution
region [29]), and for the present Gaussian instance the independent-increment
...
successive-refinement lines [35], [36] impose \emph{matrix} distortion constraints
...
\item  Y.~Xu, X.~Guang, J.~Lu, and J.~Chen. Vector Gaussian successive refinement
with degraded side information. arXiv:2002.07324, 2020.
\item  A.~Zahedi, J.~\O{}stergaard, S.~H. Jensen, P.~A. Naylor, and S.~Bech.
