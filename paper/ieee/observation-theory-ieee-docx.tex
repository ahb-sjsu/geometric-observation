...
preset bar; four of five core predictions are confirmed, one refuted; a further
trained-model test missed, then passed after correction.
\end{abstract}
...
[28], [29] makes the corner achievable (reference letter
$\hat x_0=0$).
\end{proof}
...
successively refinable---the $P=I$ case is Equitz--Cover [27]; conflict
...
proof; an external immutable deposit (Zenodo/OSF) accompanies the paper.
