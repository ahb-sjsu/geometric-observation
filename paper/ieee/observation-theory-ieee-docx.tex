...
real Llama-3.2-3B head the same blind prediction is right on $16/16$ heads while
reconstruction, held equal, is at chance ($2/16$; \S\ref{sec:discussion}). One head,
carried from definition to trained model.
\end{example}
...
The theory's mechanism thus operates on a trained Llama attention layer, called
\emph{before} compression by a blind probe; the GO-P-2026-020 miss stands as an honest
negative on the code design it exposed. Open
...
Linder--Zamir admissibility conditions [25] for $(U,D_Y)$: \emph{(a)}
