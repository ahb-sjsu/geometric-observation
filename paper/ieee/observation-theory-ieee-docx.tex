...
conceptual but empirical, and we conducted it: a preregistered blind probe on an
actual Llama-3.2-3B attention layer (Gate~B, GO-P-2026-020). It \emph{misses} the sealed
...
predictions are confirmed, one is refuted, and eleven standing negatives are retained;
