...
floor. Every empirical claim is sealed-registered against a preset bar; of the five core
...
Kostina--Verd\'u [26] normal approximation holds, the reduction gives
\[
...
case [26], parallel/colored form [27]---not re-derived.
\end{corollary}
...
with per-stage distortion measures is Rimoldi's [33]: $(R_1,R_2)$ achievable
...
[29], [34] under the reference letter $\hat x_0=0$ (which has
...
boundary rates, and the operational region [33], [29], [34] lifts the
...
[34] (finite alphabets: [33]) lifts it. Refinability pins each
...
Equitz--Cover [32]; conflict requires genuinely distinct observers. \emph{(iii) Kernel overhead.} If the base layer codes a direction in
...
\emph{Related work.} The successive-refinement line is Koshelev [28],
Equitz--Cover [32], Rimoldi [33] (per-stage measures may
differ), and, for abstract sources, Effros [29] and Kostina--Tuncel
[34], which supply the operational region invoked above. Two works are
closest, and neither subsumes ours. Nayak \emph{et al.}~[30] treat one
...
refinability can fail; Op~'t~Veld and Gastpar [31] refine a rank-deficient
...
58(6):3309--3338, 2012.
\item  A.~Ingber and Y.~Kochman. The dispersion of lossy source coding.
