...
preregistrations GO-P-2026-087/088/089 and PREREG-EC5-001, harnesses, and
committed result artifacts live in the program's campaign repository
(\texttt{observation-theory-campaigns}, EC track), with every gate
re-derived from the committed per-system data by its verification script;
the original sealing commits for 087--089 in \texttt{geometric-observation}
remain their binding registration timestamps, and Campaign 5 is sealed
natively in the campaign repository.
...
\bibitem{spgd2020} B.~Li \emph{et al.}, ``Adaptive stochastic parallel
