...
archive: tag `go10-go11-1.2` under the same concept DOI. **64 sealed
preregistrations** (040 void, 046/048/051/052 logged instrumentation misses, each
superseded and rerun; 056 a registered honest miss at its effect floors → NEG-16),
