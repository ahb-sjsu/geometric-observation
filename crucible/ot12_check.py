"""OT-12: the two floor curves, constants per PREREG-OT12-APPENDIX.md.
Machinery inherited from ot5_check_v2 (OT-5 v2), with the output-
quantization knob in place of the temperature knob.

    .venv/Scripts/python crucible/ot12_check.py
"""
...
K = 16
TEMP = 1.0
GRID = [None, 256, 64, 16, 8, 4, 2]              # None = unquantized
N_PTS = 24
N_DF_PTS = 200
N_PAIRS = 30
N_DRAWS = 2000
...
OUT = os.path.join(HERE, "..", "results", "OT12-floor-curves.json")
...
def main():
    ...
    json.dump({"claim": "OT-12", "seed": SEED, "cells": cells,
